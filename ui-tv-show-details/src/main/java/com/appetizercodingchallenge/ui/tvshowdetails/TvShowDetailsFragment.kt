...
import com.appetizercodingchallenge.ui.tvshowdetails.databinding.FragmentTvEpisodeDetailsBinding
...
class TvShowDetailsFragment :
    FragmentWithBinding<FragmentTvEpisodeDetailsBinding>() {
    ...
    override fun onViewCreated(
        binding: FragmentTvEpisodeDetailsBinding,
    ...
    override fun createBinding(
        ...
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): FragmentTvEpisodeDetailsBinding =
        FragmentTvEpisodeDetailsBinding.inflate(inflater, container, false)

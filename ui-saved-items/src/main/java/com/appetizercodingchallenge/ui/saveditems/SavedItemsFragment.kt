...
import com.appetizercodingchallenge.ui.saveditems.databinding.FragmentSearchItemsBinding
...
class SavedItemsFragment : FragmentWithBinding<FragmentSearchItemsBinding>() {
...
//        postponeEnterTransitionWithTimeout()
    ...
    private fun render(state: SavedItemsViewState) {
        binding?.state = state
    ...
    private fun createController():
            PagingEpoxyController<SavedItemsViewState,
                    SearchedItemEntryWithDetails,
                    SearchItemBindingModel_> =
        object :
            PagingEpoxyController<SavedItemsViewState,
                    SearchedItemEntryWithDetails,
                    SearchItemBindingModel_>(SavedItemsViewState()) {

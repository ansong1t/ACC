...
@Entity(tableName = "feature_movies")
data class FeatureMovie(
    ...
    @ColumnInfo(name = "collection_artist_view_url") val collectionArtistViewUrl: String = "",
    ...
    @ColumnInfo(name = "has_i_tunes_extras") val hasITunesExtras: Boolean = false,
    ...
    @ColumnInfo(name = "track_hd_rental_price") val trackHdRentalPrice: Double = 0.0,
    ...
    @ColumnInfo(name = "track_rental_price") val trackRentalPrice: Double = 0.0,
